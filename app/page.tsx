        ...
        <div className="pt-24 pb-20 grid grid-cols-1  justify-between gap-8 md:grid-cols-2 sm:pt-28">
          ...
          <div className="rounded-lg border-8 border-slate-900 bg-stone-900">
            ...
            <p className="px-5 pb-8 text-lg text-gray-300">
              ...
              dedicated to crafting high-quality digital experiences. With a
              keen interest in modern web technologies, I{`'`}ve honed my skills
              across various domains to build fast, responsive, and secure web
              applications.
            </p>
          </div>
        </div>
